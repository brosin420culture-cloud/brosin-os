...
export default function BrosinOS() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: C.outer, display: "flex", justifyContent: "center", fontFamily: "'Inter','SF Pro Display',system-ui,-apple-system,'Segoe UI',Roboto,sans-serif" }}>
      ...
      <div key={C.mode + "·" + CUR_LANG + "·" + langTick} style={{ position: "relative", width: "100%", maxWidth: 440, minHeight: "100vh", background: C.bg0, overflow: "hidden", boxShadow: C.base === "light" ? "0 0 60px rgba(120,100,40,.25)" : "0 0 60px rgba(0,0,0,.6)" }}>
