...
<meta name="brosin-build" content="v43" />
...
<script>
  ...
  window.storage = {
    ...
    // OJO: no tragarse el error. Si el almacén está lleno, la app tiene que
    // enterarse para avisar; antes fallaba en silencio y parecía que guardaba.
    set: async function(k,v){ localStorage.setItem("brosin:"+k, JSON.stringify(v)); return true; }
  };
...
<div id="root">
  <div id="splash">
    ...
    <div class="s">Despertando la colmena… · v43</div>
    <div class="l"></div>
  </div>
</div>
<script type="module">
